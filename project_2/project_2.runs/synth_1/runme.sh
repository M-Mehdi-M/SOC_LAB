...
HD_PWD='D:/lab_1/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afisare_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afisare_7seg.tcl
