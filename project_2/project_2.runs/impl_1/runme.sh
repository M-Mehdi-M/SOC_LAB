...
HD_PWD='D:/lab_1/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log afisare_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source afisare_7seg.tcl -notrace
